...
const Dashboard = () => {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const predData = timeSeriesValues
        .slice(windowSize)
        .map((value, index) => ({
      ...
      <Paper sx={{ p: 2, mb: 3 }}>
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} md={8}>
            <Button variant="contained" onClick={runAnalysis} fullWidth>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }}>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={predictions.length ? predictions : []}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="time" />
                <YAxis />
                <Tooltip />
            ...
            {predictions.length === 0 && (
              ...
              >
                Cliquez sur &quot;Exécuter l&apos;analyse prédictive&quot; pour
            ...
            <Paper sx={{ p: 2 }}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} md={4}>
                  <Card>
                    <CardContent>
                      <Typography color="textSecondary">Tendance</Typography>
                      <Typography variant="h5">
                        {analysis.trend > 0 ? "↗" : "↘"}
                    ...
                    <CardContent>
                      ...
                      <Typography variant="h5">
                        {analysis.seasonality?.length > 0
                          ? Math.max(
                              ...analysis.seasonality.map(Math.abs)
                            ).toFixed(3)
                          : "0"}
                      </Typography>
                    </CardContent>
